...
deployable-turret-component-cant-access-wires = Ты не можешь добраться до панели обслуживания, пока турель активна
# Turret notification for station AI
station-ai-turret-is-attacking-warning = { CAPITALIZE($source) } вступил(а) в бой с враждебной целью.
